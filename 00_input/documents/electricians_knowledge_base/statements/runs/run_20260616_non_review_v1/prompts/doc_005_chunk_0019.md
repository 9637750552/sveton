...

{
  ...
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "**Напряжение в сети 180В.** 6.4 Аномальная температура в месте установки(меньше -8С и больше +26С).",
  "next_context": "**Температура в месте установки -10С.** 6.5 Малая ёмкость АКБ(когда необходимы аккумуляторы большей емкости, или нужна еще одна группа).",
  "needs_review": false,
  "review_reasons": [],
