...

{
  ...
  "text": "*5. Проложена кабель-трасса в коробе 8 метров, с проходом двух стен.*",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "*Щит котельной подключены все автоматы к одной резервной фазе(трехфазных потребителей нет).*",
  "next_context": "*Проложена отдельная кабель-трасса в гофре 3х2.5, 4 метра для розетки холодильника. Подключена к автомату №16 в щите дома.*",
  "needs_review": false,
  "review_reasons": [],
