...

{
  ...
  "text": "**15А. Максимальная нагрузка составила 5,2 кВт.**",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "**Пример: На инверторе установлен ток заряда 20А, замер тока составил составил**",
