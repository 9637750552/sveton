...

{
  ...
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "*№3(щит котельной).*",
  "next_context": "*Щит котельной подключены все автоматы к одной резервной фазе(трехфазных потребителей нет).*",
  "needs_review": false,
  "review_reasons": [],
