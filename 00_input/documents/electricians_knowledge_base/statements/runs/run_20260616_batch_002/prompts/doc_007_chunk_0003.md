...

{
  ...
  "text": "*<u>В папке контрагента должны находиться:</u>*",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "**Требования к действиям менеджера по продажам при оформлении заявки на монтаж**",
  "next_context": "**- Фото открытого щита или щитов, в котором будут проводиться работы.**",
  "needs_review": false,
  "review_reasons": [],
