...

{
  ...
  "text": "*Щит гаража №6,8,9, первая фаза автомата №2 щит(щит дома), Третья фаза автомата*",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "*4. В группе резерва установлены автоматы:*",
  "next_context": "*№3(щит котельной).*",
  "needs_review": false,
  "review_reasons": [],
