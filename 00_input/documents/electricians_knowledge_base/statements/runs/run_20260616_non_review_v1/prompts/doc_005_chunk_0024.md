...

{
  ...
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "**АКБ 100 Ач. быстро разряжаются.** 6.6 При монтаже оказался неисправен инвертор, балансир и другое оборудование(указать подробности).",
  "next_context": "**В процессе монтажа вышел из строя балансир(при включении), заменен на новый из набора ЗИП.** ПРИМЕР 2:",
  "needs_review": false,
  "review_reasons": [],
