...

{
  ...
  "text": "**- Фото открытого щита или щитов, в котором будут проводиться работы.**",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "* В папке контрагента должны находиться: *",
  "next_context": "**- Фото подписанной клиентом заявки на подбор оборудования.**",
  "needs_review": false,
  "review_reasons": [],
