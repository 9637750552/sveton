...

{
  ...
  "text": "**Щит гаража №6,8,9, первая фаза автомата №2 щит(щит дома), Третья фаза автомата №3(щит котельной).**",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "**Пример: В группе резерва установлены автоматы:**",
  "next_context": "**Щит дома № 3,4,5,6,7,10,12,16.**",
  "needs_review": false,
  "review_reasons": [],
