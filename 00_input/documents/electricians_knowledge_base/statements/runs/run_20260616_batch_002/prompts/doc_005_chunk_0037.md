...

{
  ...
  "text": "*6.Система будет использоваться в ручном режиме, клиент подписал соответствующую расписку.*",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "*Проложена отдельная кабель-трасса в гофре 3х2.5, 4 метра для розетки холодильника. Подключена к автомату №16 в щите дома.*",
  "next_context": "",
  "needs_review": false,
  "review_reasons": [],
