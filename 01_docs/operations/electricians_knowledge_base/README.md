...
| `04_installation_process.md` | собран | `C009 / installation_process` | 101 | 26 | `ЭЛК_3_Базовые_знания_Описание_этапов_монтажа_ред1_9.docx` | Раздел собран как черновик; `77` пунктов разнесены в safety-review пакет `SR011-SR016`, визуальный слой `doc_015` перенесен в assets и связан через `statement_images.jsonl`. |
