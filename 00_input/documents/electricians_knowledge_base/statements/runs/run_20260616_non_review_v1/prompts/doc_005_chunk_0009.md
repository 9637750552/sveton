...

{
  ...
  "text": "**Щит дома № 3,4,5,6,7,10,12,16.**",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "**Щит гаража №6,8,9, первая фаза автомата №2 щит(щит дома), Третья фаза автомата №3(щит котельной).**",
  "next_context": "**Щит котельной подключены все автоматы к одной резервной фазе(трехфазных потребителей нет).** 5\\. Кабель-трасса. 5.1. Проложена кабель-трасса, в коробе/гофре(метров), с проходом(если есть, то указать количество).",
  "needs_review": false,
  "review_reasons": [],
