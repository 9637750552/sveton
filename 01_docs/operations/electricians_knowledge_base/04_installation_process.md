...
Статус: черновик редакционного раздела на базе canonical-утверждений и визуальных примеров из исходного DOCX. Pre-expert safety audit выполнен; технически критичные пункты остаются `blocked_for_instruction` до expert review.
...
- Safety-review пакет для всех `77` safety-critical утверждений подготовлен в `safety_review_c009_installation_process.md`; pre-expert audit выполнен, но перед выпуском финальной монтажной инструкции нужен экспертный technical review по `SR011-SR016`.
