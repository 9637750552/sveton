...

{
  ...
  "text": "**- Фото помещения, где будет устанавливаться ИБП, по кругу. А также, если имеется, то альтернативного места установки.**\n\nТ.е. должны быть фотографии каждой стены помещения от пола до потолка.",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "**- Фото того, где и как должен быть расположен ИБП, а также как пойдёт кабель-канал.** При необходимости схема помещений.",
  "next_context": "* В текстовом файле ТЗ должны быть: *",
  "needs_review": false,
  "review_reasons": [],
