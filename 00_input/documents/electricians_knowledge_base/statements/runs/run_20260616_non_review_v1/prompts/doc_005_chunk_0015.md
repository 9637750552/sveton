...

{
  ...
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "**Максимальная нагрузка составила 5,2кВт.** 6.2 Использование системы в ручном режиме.",
  "next_context": "**Система будет использоваться в ручном режиме, клиент подписал соотствующую расписку.** 6.3 Аномальное напряжение в сети(меньше 185В и больше 245В).",
  "needs_review": false,
  "review_reasons": [],
