...
{
  "chunk_id": "doc_006_chunk_0009",
  "source_document_id": "doc_006",
  "source_file": "Правила_фотосъемки_монтажа_Чек_лист_ред1.docx",
  "topic": "Фотофиксация монтажа",
  "roles": [
    "монтажник",
    "инженер ГО"
  ],
  ...
  "text": "*Иные фотографии:*\n\n> \\[ \\] Подгорелая проводка в щите; батарея рядом с системой, даже если заглушена; пыльное помещение, помещение, в котором происходит ремонт и т.д.",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "*Фото документов, актов, чеков:* > [ ] При внесении записей в акты и иные документы, данный документ необходимо сфотографировать. > [ ] После получения чеков через терминал их необходимо сфотографировать и отправить в чат \"Оплаты на выезде\".",
  "next_context": "**Правило съёмки установленного оборудования** Необходимо сделать 4-6 фотографий с разных ракурсов и сторон. Важно! - Система должна целиком помещаться на фотографии с запасом по всем 4-м сторонам. - Необходимо убедиться, что фотографии чёткие, сделаны без размытия. [IMAGE:img_0001|media/image1.jpeg|ready_for_linking|Важно!] [IMAGE:img_0002|media/i",
  "needs_review": false,
  "review_reasons": [],
  "suggested_topic": "photo_report",
  "suggested_roles": [
    "hq_engineer",
    "installer"
  ]
