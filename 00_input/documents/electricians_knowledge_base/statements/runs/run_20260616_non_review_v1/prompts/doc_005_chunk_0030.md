...

{
  ...
  "text": "*4. В группе резерва установлены автоматы:*",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "*Температура в месте установки 24C.*",
  "next_context": "*Щит гаража №6,8,9, первая фаза автомата №2 щит(щит дома), Третья фаза автомата*",
  "needs_review": false,
  "review_reasons": [],
