...

{
  ...
  "text": "**Требования к действиям менеджера по продажам при оформлении заявки на монтаж**",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "**Контроль исполнения технических функций менеджера по продажам**",
  "next_context": "* В папке контрагента должны находиться: *",
  "needs_review": false,
  "review_reasons": [],
