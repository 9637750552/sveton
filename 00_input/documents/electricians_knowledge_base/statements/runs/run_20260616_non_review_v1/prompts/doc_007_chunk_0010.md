...

{
  ...
  "text": "**- Описание особенностей установки ИБП. Обязательно.**",
  "related_image_ids": [],
  "excluded_image_ids": [],
  "previous_context": "* В текстовом файле ТЗ должны быть: *",
  "next_context": "**- Конфигурация инверторов в системах 10 кВт и более**",
  "needs_review": false,
  "review_reasons": [],
